defmodule ChatterWeb.Plugs.Auth do
  import Plug.Conn
  import Phoenix.Controller
  alias ChatterWeb.Router.Helpers
  alias ChatterWeb.ErrorView

  def init(opts), do: opts

  def call(conn, _opts) do
    user_id = get_session(conn, :user_id)
    user = user_id && Chatter.Accounts.get_user!(user_id)
  ...
  defp put_current_user(conn, user) do
    ...
    |> assign(
      :admin_user,
      !!user && !!user.credential && user.credential.email == "dss@in.gr"
    )
  end
end
