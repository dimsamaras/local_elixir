defmodule Chatter.AccountsTest do
  ...
  describe "credentials" do
    alias Chatter.Accounts.Credential
    ...
    @invalid_attrs %{email: nil, password_hash: nil, user_id: nil}
    ...
    test "create_credential/1 with valid data creates a credential" do
      ...
      assert credential.user_id == "some user_id"
    end
    ...
    test "update_credential/2 with valid data updates the credential" do
      ...
      assert credential.user_id == "some updated user_id"
    end
