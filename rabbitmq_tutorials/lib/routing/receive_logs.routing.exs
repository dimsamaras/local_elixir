defmodule LogReceiverDirect do
...
IO.puts """
  [*] Waiting for messages with severity [#{inspect severities}]. To exit press CTRL+C, CTRL+C
"""

LogReceiverDirect.wait_for_messages(channel)
